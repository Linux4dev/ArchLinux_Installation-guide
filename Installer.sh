...
then	
	...
	echo " "
	echo "-s2 : Inicializa a segunda parte do script, responsvel pela configuracao e instalacao de pacotes essenciais."
	echo " "
	echo "--wifi : Utilizado para realizar as configuracoes semi-automaticas do netplan que irao te permitir se conectar via Wifi"
	echo " "
fi
